  ...
  return (
    <div className='scroll-animation-homepage'>
      ...
      <div className="scroll-animation-homepage-right">
        ...
        <img style={{height:"60vh"}} src="./images/Seed1.png" alt="" className={`hidden-i-animation ${isvisible1 ? 'show-i-animation ' : ''}`} />
        <img style={{height:"65vh"}} src="./images/image2-animation.jpg" alt="" className={`hidden-i-animation ${isvisible2 ? 'show-i-animation ' : ''}`} />
        <img style={{height:"70vh"}} src="./images/image3-animation.png" className={`hidden-i-animation ${isvisible3 ? 'show-i-animation ' : ''}`} />
        <img style={{height:"75vh"}} src="./images/Tree.png" alt="" className={`hidden-i-animation ${isvisible4 ? 'show-i-animation ' : ''}`} />
