  ...
  return (
    <div className='our-team-section-aboutus' style={{backgroundColor:"black"}}>
      <div style={{ backgroundColor: "black", color: "white", padding: "10px"}}>
        <h1 className='our-team-and-advisor-title' style={{ textAlign: "center", margin: "10px" }}>Our Team</h1>
        <div className="zl-staff-items " >
          <SingleTeamMember img={"./images/adviser/palashsir.jpeg"} name={"Palash Garg"} desc={"MD - MII Foundation"}
          ...
          <SingleTeamMember img={"./images/adviser/arnavsir.jpg"} name={"Arnav Mishra "} desc={"CEO - MII Foundation"}
