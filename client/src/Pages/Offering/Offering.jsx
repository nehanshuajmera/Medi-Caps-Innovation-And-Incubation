  ...
  return (
    <div className="offering-main-container ">
      ...
      <div className='home-svg-services' style={{ margin: "5px", padding: "4px" }}>
        ...
        <div className="offering-section-1-text">
            <p style={{ fontWeight: '300', paddingBottom:"4px" }}>Offers</p>
            <h1 className="not-offering-on-mobile" style={{ fontWeight: '400'}}>INCUBATION | CONSULTING | MENTORING | FUNDING | ACCELERATION</h1>
            <h1 className="offering-on-mobile" style={{ fontWeight: '400'}}>INCUBATION CONSULTING MENTORING FUNDING ACCELERATION</h1>
            <p style={{ fontWeight: '300' }}>To help start-ups grow and succeed</p>
      </div>
      </div>
