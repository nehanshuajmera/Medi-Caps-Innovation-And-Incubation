    ...
    <div className="footer-pg scroll-sections">
      <div className="footer-main-box">
        ...
        <div className="footer-social-media-links">
          <NavLink to='mailto:miif@medicaps.ac.in' target='_blank'><img src="./images/gmail.png" alt="" /></NavLink>
          <NavLink to='https://www.instagram.com/miifoundation/' target='_blank'><img src="./images/instagram.png" alt="" /></NavLink>
          {/* <NavLink to='' target='_blank'><img src="./images/facebook.png" alt="" /></NavLink> */}
          <NavLink to='https://twitter.com/miifindia' target='_blank'><img src="./images/twitter.png" alt="" /></NavLink>
          <NavLink to='https://www.linkedin.com/company/mii-foundation/' target='_blank'><img src="./images/linkedin.png" alt="" /></NavLink>
        </div>
      </div>
    </div>
  )
