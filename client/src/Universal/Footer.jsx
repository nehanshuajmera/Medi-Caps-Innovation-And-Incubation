...
export default function Footer() {
  return (
    <div className='scroll-sections hunderedvh'>
      ...
      <div className='right-footer'>
        <p><i class="fa-solid fa-location-dot"></i> Medi-Caps University
A.B. Road, Pigdamber, Rau Indore - 453331 </p>
<p><i class="fa-solid fa-phone"></i> 9876543211</p>
      <p><i class="fa-solid fa-envelope"></i> info@miifoundation.com</p>
      <p className='socialsection'><i class="fa-brands fa-linkedin-in fa-3x"></i> <i class="fa-brands fa-instagram fa-3x"></i> <i class="fa-brands fa-twitter fa-3x"></i> <i class="fa-brands fa-youtube fa-3x"></i> </p>
      </div>
      </div>
          </div>
  )
