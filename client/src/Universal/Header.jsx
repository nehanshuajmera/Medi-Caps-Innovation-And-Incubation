        ...
        <div className="container">
          <div className="column one">
            <div className="top_bar_left clearfix">
              <div className="logo">
                <a id="logo" href="index-lottie.html" title="BeLottie - Betheme" data-height={60} data-padding={15}>
                    <img className="logo-main scale-with-grid svg" src="content/lottie/images/lottie.svg" data-retina data-height alt="lottie" data-no-retina /></a>
              </div>
